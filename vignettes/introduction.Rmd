...
supports four estimation backends:

- **mgcv** -- GAM/BAM via `gam()`, `bam()`, `gamm()`. Ships with R. Default.
- **lme4** -- LMM/GLMM via `lmer()`, `glmer()`. Open-source, CRAN.
- **ASReml-R** -- REML estimation. Commercial licence. Advanced structures (FA, AR1).
