...
- [`print(`*`<fda_basis>`*`)`](https://biometryhub.github.io/funcrop/reference/print.fda_basis.md)
  : Print Method for fda_basis Objects
- [`print(`*`<fda_comparison>`*`)`](https://biometryhub.github.io/funcrop/reference/print.fda_comparison.md)
  : Print method for fda_comparison
- [`print(`*`<fda_data>`*`)`](https://biometryhub.github.io/funcrop/reference/print.fda_data.md)
  : Print method for fda_data
- [`print(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/print.fda_model.md)
  : Print method for fda_model
- [`print(`*`<fda_tensor_basis>`*`)`](https://biometryhub.github.io/funcrop/reference/print.fda_tensor_basis.md)
  : Print Method for fda_tensor_basis Objects
- [`summary(`*`<fda_comparison>`*`)`](https://biometryhub.github.io/funcrop/reference/summary.fda_comparison.md)
  : Summary method for fda_comparison
- [`summary(`*`<fda_data>`*`)`](https://biometryhub.github.io/funcrop/reference/summary.fda_data.md)
  : Summary method for fda_data
- [`summary(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/summary.fda_model.md)
  : Summary method for fda_model
- [`plot(`*`<fda_basis>`*`)`](https://biometryhub.github.io/funcrop/reference/plot.fda_basis.md)
  : Plot Method for fda_basis Objects
- [`plot(`*`<fda_comparison>`*`)`](https://biometryhub.github.io/funcrop/reference/plot.fda_comparison.md)
  : Plot method for fda_comparison
- [`plot(`*`<fda_data>`*`)`](https://biometryhub.github.io/funcrop/reference/plot.fda_data.md)
  : Plot method for fda_data (spaghetti plot)
- [`plot(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/plot.fda_model.md)
  : Plot method for fda_model
- [`coef(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/coef.fda_model.md)
  : Extract coefficient function beta(t) from fda_model
- [`fitted(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/fitted.fda_model.md)
  : Extract fitted curves from fda_model
- [`residuals(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/residuals.fda_model.md)
  : Extract residuals from fda_model
- [`vcov(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/vcov.fda_model.md)
  : Extract variance-covariance information from fda_model
- [`as.data.table.fda_data()`](https://biometryhub.github.io/funcrop/reference/as.data.table.fda_data.md)
  : Coerce fda_data to data.table
- [`` `[`( ``*`<fda_data>`*`)`](https://biometryhub.github.io/funcrop/reference/sub-.fda_data.md)
...
- [`predict(`*`<fda_model>`*`)`](https://biometryhub.github.io/funcrop/reference/predict.fda_model.md)
...
- [`plot_functional_profiles()`](https://biometryhub.github.io/funcrop/reference/plot_functional_profiles.md)
  : Plot Fitted Functional Profiles
- [`plot_coefficient_function()`](https://biometryhub.github.io/funcrop/reference/plot_coefficient_function.md)
  : Plot the Coefficient Function
- [`plot_gxe_heatmap()`](https://biometryhub.github.io/funcrop/reference/plot_gxe_heatmap.md)
  : Heatmap of Genotype-by-Environment Interaction
- [`plot_fa_biplot()`](https://biometryhub.github.io/funcrop/reference/plot_fa_biplot.md)
  : Factor-Analytic Biplot for GxE Interaction
- [`plot_backend_comparison()`](https://biometryhub.github.io/funcrop/reference/plot_backend_comparison.md)
...
- [`funcrop_default_engine()`](https://biometryhub.github.io/funcrop/reference/funcrop_default_engine.md)
...
- [`sim_grain_fill`](https://biometryhub.github.io/funcrop/reference/sim_grain_fill.md)
  : Simulated Grain-Fill Trial Data
- [`sim_met_fda`](https://biometryhub.github.io/funcrop/reference/sim_met_fda.md)
