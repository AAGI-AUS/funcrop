# funcrop ![](reference/figures/logo.png)
...
funcrop auto-detects the best available backend (mgcv \> lme4 \> ASReml
\> bayesreml). Override with the `engine` argument or set a session
default:
...
Funded by the [Analytics for the Australian Grains Industry
(AAGI)](https://www.aagi.com.au/) project. Developed at the University
of Adelaide.
