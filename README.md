...
<!-- badges: start -->
[![R-CMD-check](https://github.com/max578/funcrop/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/max578/funcrop/actions/workflows/R-CMD-check.yaml)
...
```r
# From GitHub
remotes::install_github("max578/funcrop")
```
